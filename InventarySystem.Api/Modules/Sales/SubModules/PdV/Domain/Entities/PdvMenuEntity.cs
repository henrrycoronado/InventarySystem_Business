...
public class PdvMenuEntity
{
    ...
    internal PdvMenuEntity() { }

    public static PdvMenuEntity Create(int companyId, string name) =>
        new() { CompanyId = companyId, Name = name, IsActive = true, CreatedAt = DateTime.Now };

    public void Deactivate() => IsActive = false;

    internal PdvMenuEntity Init(int id, int companyId, string name, bool isActive, DateTime createdAt)
    {
